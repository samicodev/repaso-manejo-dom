...
const primerToppingNaranjaEtiqueta = document.querySelector('ul li.fondo-naranja');
console.log(primerToppingNaranjaEtiqueta);
...
const toppingshtml = document.getElementsByClassName('topping');


for(const topping of toppingshtml){
